        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("PhoneValidEgpConstraint", "Phone like '01[0125]%' and Phone not like '%[^0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("PhoneValidEgpConstraint1", "Phone like '01[0125]%' and Phone not like '%[^0-9]%'");
                });
